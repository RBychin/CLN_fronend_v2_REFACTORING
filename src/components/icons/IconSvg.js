    ...
    if (icon === 'add_account') {
        return (
            <svg className={style} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M9 12H15" stroke={color} stroke-width="2" stroke-linecap="round" strokeLinejoin="round"/>
                <path d="M12 9L12 15" stroke={color} stroke-width="2" stroke-linecap="round" strokeLinejoin="round"/>
